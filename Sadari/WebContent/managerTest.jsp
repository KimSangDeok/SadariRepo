			...
			<div>
				<h2>관리자</h2>
				  <div class="list-group">
				    <a href="#" class="list-group-item active" style="text-align: center; font-size:25px">검수</a>
				    <a href="sadari.sadari?cmd=payment" class="list-group-item" style="text-align: center; font-size:25px">결제</a>
